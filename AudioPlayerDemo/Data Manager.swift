...
struct DataManager {
    ...
    static func getAudioDataWithSuccess(success: @escaping ((_ metaData: Data?) -> Void)) {
    ...
    static func getDataFromFileWithSuccess(success: (_ data: Data?) -> Void) {
        guard let filePathURL = Bundle.main.url(forResource: "AudioSamples", withExtension: "json") else {
